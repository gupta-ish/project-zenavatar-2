...
def scp_to_remote(source_path, remote_hosts, remote_user="your_username", remote_base_dir= "/home/tairanhe/workspace/humanoidverse/humanoidverse/logs"):
    """
...
def main():
    ...
    parser.add_argument("--remote-dir", default="~/workspace/humanoidverse/",
