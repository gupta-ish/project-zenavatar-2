...
# Example usage
xml_file_path = "/media/tairanh/lecar4tb/tairanh/Workspace/humanoidverse/humanoidverse/data/robots/ea/atlas_r1_nub_hand.xml"  # Replace with your XML file path
