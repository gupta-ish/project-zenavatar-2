...
class DecoupledLocomotionManipulationForcePolicy(DecoupledLocomotionManipulationPolicy):
    ...
    def policy_action(self):
        ...
        if not self.estimating_force:
            global_left_ee_estimated_force *= 0.0
            global_right_ee_estimated_force *= 0.0
        print("global_left_ee_estimated_force: ", global_left_ee_estimated_force, " global_right_ee_estimated_force: ", global_right_ee_estimated_force)
        if self.init_force_shm and self.estimating_force: 
    ...
    def calculate_ee_torque_compensation(self, left_ee_force, right_ee_force, qpos, qvel):
        ...
        mujoco.mj_jacBodyCom(self.model, self.data, Jl[:3], Jl[3:], self.frames_idx['left_rubber_hand'])
        mujoco.mj_jacBodyCom(self.model, self.data, Jr[:3], Jr[3:], self.frames_idx['right_rubber_hand'])
