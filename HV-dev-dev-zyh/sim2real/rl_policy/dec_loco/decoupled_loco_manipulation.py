...
from decoupled_locomotion_stand_height import DecoupledLocomotionStandHeightPolicy
...
class DecoupledLocomotionManipulationPolicy(DecoupledLocomotionStandHeightPolicy):
    def __init__(self, 
                 config, 
                 avp_config,
                 model_path, 
    ...
    def init_upper_body_controller(self):
        ...
        # Load waypoints
        self.angle = np.radians(-3)
        self.EE_left_R = np.eye(3)
        self.EE_right_R = np.eye(3)
        self.EE_left_x = 0.25
        self.EE_right_x = 0.25
        self.EE_left_y = 0.15
        self.EE_right_y = -0.15
        self.EE_left_z = 0.08
        self.EE_right_z = 0.08
        self.update_waypoints()
        # Set initial interpolated positions and orientations
    ...
    def prepare_obs_for_rl(self, robot_state_data):
        ...
        self.logger.info(colored(f"dof_pos: {dof_pos}", "green"))
...
if __name__ == "__main__":
    ...
    policy = DecoupledLocomotionManipulationPolicy(config=config, 
