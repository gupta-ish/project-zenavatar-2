...
class LeggedRobotBase(BaseTask):
    ...
    def _init_buffers(self):
        ...
        self.add_noise_currculum = self.config.obs.get("add_noise_curriculum", False)
    ...
    def _prepare_reward_function(self):
        ...
        self.use_reward_limits_dof_pos_curriculum = self.config.rewards.reward_limit.get("reward_limits_curriculum", {}).get("soft_dof_pos_curriculum", False)
        self.use_reward_limits_dof_vel_curriculum = self.config.rewards.reward_limit.get("reward_limits_curriculum", {}).get("soft_dof_pos_curriculum", False)
        self.use_reward_limits_torque_curriculum = self.config.rewards.reward_limit.get("reward_limits_curriculum", {}).get("soft_dof_pos_curriculum", False)
