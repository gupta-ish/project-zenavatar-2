...
from humanoidverse.envs.decoupled_locomotion.decoupled_locomotion_stand_height_force import LeggedRobotDecoupledLocomotionStanceHeightForce
...
DEBUG = False
class LeggedRobotDecoupledLocomotionStanceHeightForceEstimator(LeggedRobotDecoupledLocomotionStanceHeightForce):
    ...
    def _apply_force_in_physics_step(self):
        ...
        if self.is_evaluating:
            ...
            left_hand_force[:, 2] = -25.0
            right_hand_force[:, 2] = -25.0
            pass
        ...
        if self.config.apply_force_compensation_in_physics_step:
            self._apply_force_compensation_in_physics_step(left_hand_force * 0.0, right_hand_force * 0.0)
