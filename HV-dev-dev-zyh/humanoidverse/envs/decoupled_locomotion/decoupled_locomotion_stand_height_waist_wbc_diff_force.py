...
from humanoidverse.envs.decoupled_locomotion.decoupled_locomotion_stand_height_waist_wbc import LeggedRobotDecoupledLocomotionStanceHeightWBC
...
class LeggedRobotDecoupledLocomotionStanceHeightWBCForce(LeggedRobotDecoupledLocomotionStanceHeightWBC):
    ...
    def _apply_force_in_physics_step(self):
        ...
        if self.is_evaluating:
            ...
            # left_hand_force[:, 0] = 10.0
            # right_hand_force[:, 0] = 10.0
            # left_hand_force[:, 2] = -30.0
            # right_hand_force[:, 2] = -20.0
            pass
