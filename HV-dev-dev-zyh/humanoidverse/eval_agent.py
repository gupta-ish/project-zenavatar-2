...
def main(override_config: OmegaConf):
    ...
    import torch
    from humanoidverse.utils.inference_helpers import export_policy_as_jit, export_policy_as_onnx
    from humanoidverse.utils.inference_helpers import export_decouple_policy_and_estimator_as_onnx, export_decouple_policy_and_estimator_history_as_onnx
    ...
    if EXPORT_ONNX:
        ...
        # Yuanhang: export decoupled policy and estimator as onnx
        # export_decouple_policy_and_estimator_as_onnx(algo.inference_model, exported_policy_path, exported_onnx_name, example_obs_dict)
